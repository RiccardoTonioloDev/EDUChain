...
<div class="container">
    <div class="intestazione">Quante monete EDU desideri ritirare dal tuo saldo <?php echo $_SESSION["username"]; ?>?</div>
    <form  action="../elaborazioneRichieste.php" method="post" class="saldo-card">
        ...
        <button class="refresh-button" type="submit" name="ritira" value="Ritira">Ritira</button>
    </form>
