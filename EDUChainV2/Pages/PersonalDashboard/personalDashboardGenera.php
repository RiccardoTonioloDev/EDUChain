...
<body>
    ...
    <div class="pageContainer">
        <form class="card-form" action="../elaborazioneRichieste.php" method="post">
            <div class="intestazione">Genera monete EDU</div>
            <label for="quantity" class="intestazioneInsert">Inserisci il numero di monete che desideri ricevere:</label>
            <div class="card-insert">
                <input name="quantity" type="number" class="typeText" required>
                <button name="genera" value="Genera" type="submit" class="button-form-send">Genera</button>
            </div>
        </form>
    </div>
    <script>
