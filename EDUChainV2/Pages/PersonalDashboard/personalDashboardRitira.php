...
<body>
    ...
    <div class="pageContainer">
        <form class="card-form" action="../elaborazioneRichieste.php" method="post">
            <div class="intestazione">Ritira monete EDU</div>
            <label for="quantity" class="intestazioneInsert">Inserisci il numero di monete che desideri ritirare dal tuo conto:</label>
            <div class="card-insert">
                <input name="quantity" type="number" class="typeText" required>
                <button name="ritira" value="Ritira" type="submit" class="button-form-send">Ritira</button>
            </div>
        </form>
    </div>
    <script>
